    ...
    def set_http_response_login(self):
        cadena = "<html>\
                    <meta charset='utf-8'>\
                        <html>\
                            <meta charset='utf-8'>\
                            <a href='index.html' class='btn btn-primary btn-lg active' role='button' aria-pressed='true' >Volver</a>\
                            <div class='row justify-content-center'>\
                                <form action='login' method='POST' class='form-inline'>\
                                    <input type='text' name='nick' id='nick' maxlength='70' placeholder='Nick del usuario' required>\
